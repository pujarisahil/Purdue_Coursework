...
public class Copy_4_of_Polynomial {
...
//				}
	...
	private static boolean isTopwithHigerPrecedence(ExpressionAtom peek, ExpressionAtom token) {
		...
		System.out.println("Peek : " + peek.getVariablesOrOperator()) ;
		System.out.println("token : " + token.getVariablesOrOperator()) ;
...
//					}
		...
		Utils.printExpression(expressionStack.peek());
	}
...
//		evaluatedExpression.sort(new Comparator<ExpressionAtom>(){
//			@Override
//			public int compare(ExpressionAtom o1, ExpressionAtom o2) {
//				if(o1.getVariablesOrOperator().charAt(0) == o2.getVariablesOrOperator().charAt(0)) return 0;
//				else if(o1.getVariablesOrOperator().charAt(0) == 'x') return 1 ;
//				else return -1 ;
//			}
//		});
//		
	...
	public Copy_4_of_Polynomial(String inputPolynomial) {
